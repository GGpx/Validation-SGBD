...
<main style="height: 100vh">
    ...
    <table>
        ...
        ?>
            ...
            <tr>
                <td><input type="text" name="nameP" value="<?php echo $allProduct['nameP'] ?>"></td>
                <td><input type="date" name="dateP" value="<?php echo $allProduct['dateP'] ?>"></td>
                <td><input type="text" name="descriptionP" value="<?php echo $allProduct['descriptionP'] ?>"></td>
